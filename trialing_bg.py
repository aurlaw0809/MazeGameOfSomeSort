...
sky = pygame.image.load('assets/skies/1.png').convert_alpha()

scale_factor = SCREEN_HEIGHT / sky.get_height()

sky = pygame.transform.scale_by(sky, scale_factor)

shoot = pygame.image.load('assets/skies/2.png').convert_alpha()
shoot = pygame.transform.scale_by(shoot, scale_factor)

back_cloud = pygame.image.load('assets/skies/3.png').convert_alpha()
back_cloud = pygame.transform.scale_by(back_cloud, scale_factor)

middle_cloud = pygame.image.load('assets/skies/4.png').convert_alpha()
middle_cloud = pygame.transform.scale_by(middle_cloud, scale_factor)

front_cloud = pygame.image.load('assets/skies/5.png').convert_alpha()
