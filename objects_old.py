...
class Object:
    def __init__(self, controller, name, pos, solid, transparent, size):
    ...
    def __repr__(self):
        return f'name: {self.name}, pos: {self.pos}, solid: {self.solid}, transparent: {self.transparent}, size: {self.size}'
